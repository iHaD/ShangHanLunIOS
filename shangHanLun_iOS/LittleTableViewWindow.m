...
//        NSString *left = app.fangAliasDict[lw.searchText]?:lw.searchText;
//        NSString *right = app.fangAliasDict[text]?:text;
//        if ([left isEqualToString:right] && [self isInFangContext]) {
...
//    NSDictionary *dict = app.fangAliasDict;
//    
//    __block CGFloat totalHeight = 0;
//    NSString *fang = text;
//    NSString *right = dict[fang] ? : fang;
...
//                NSString *left = dict[obj2.fangList.firstObject] ? : obj2.fangList.firstObject;
...
//    }
//    
//    [app.curContent enumerateObjectsUsingBlock:^(HH2SectionData *obj, NSUInteger idx, BOOL *stop){
//        if (app.curContent == app.content) {
//            if (idx < 8) {
//                return;
//            }
//            if (idx == 18) {
...
- (void)gotoContent:(UIButton *)btn
{
    ...
    AppDelegate *app = (AppDelegate *)[UIApplication sharedApplication].delegate;
//    HH2SearchViewController *fang = [[ViewController alloc] initWithStyle:UITableViewStylePlain data:app.curContent];
